...
public class MiningInPlace {
    ...
    public static ConcurrentHashMap<UUID, Map<Config.ClientConfigs, Object>> playerConfigs = new ConcurrentHashMap<>();
    public static ConcurrentHashMap<UUID, Boolean> playerKeyState = new ConcurrentHashMap<>();
