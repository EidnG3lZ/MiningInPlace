...
public class OnBlockDrops {
    ...
    public static void onBlockDrops(BlockDropsEvent event) {
        ...
        final Vec3 ITEM_INITIAL_VELOCITY = new Vec3(0, 0.3, 0);
        final Vec3 PLAYER_CAMERA_POS_OFFSET = new Vec3(0, 1.5, 0);
...
//                Vec3 offsetVec = relativelyVec.normalize().multiply(OFFSET, OFFSET, OFFSET);
                ...
                Vec3 moveToVec = eventPos.getCenter().add(offsetVec).add(0, -ITEM_ENTITY_SIZE / 2, 0);
